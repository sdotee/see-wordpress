...
$text_history = SDOTEE_Helpers::get_history( 'sdotee_text_history' );
$file_history = SDOTEE_Helpers::get_history( 'sdotee_file_history' );
?>
		...
		<div id="sdotee-tab-text" class="sdotee-tab-content sdotee-tab-active">
			...
			<table class="wp-list-table widefat fixed striped sdotee-history-table">
				...
				<tbody>
					...
					<tr id="sdotee-text-row-<?php echo esc_attr( $entry['id'] ); ?>">
						...
						<td>
							<button type="button" class="button button-small sdotee-copy-btn" data-url="<?php echo esc_attr( $entry['url'] ); ?>">
								<?php esc_html_e( 'Copy', 'sdotee' ); ?>
							</button>
		...
		<div id="sdotee-tab-file" class="sdotee-tab-content" style="display:none;">
			...
			<table class="wp-list-table widefat fixed striped sdotee-history-table">
				...
				<tbody>
					...
					<tr id="sdotee-file-row-<?php echo esc_attr( $entry['id'] ); ?>">
						...
						<td>
							...
							<a href="<?php echo esc_url( $entry['page'] ); ?>" target="_blank">
								<?php echo esc_html( $entry['page'] ); ?>
							</a>
							<?php else : ?>
							—
							<?php endif; ?>
